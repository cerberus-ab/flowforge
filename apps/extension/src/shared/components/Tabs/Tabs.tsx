...
export function Tabs({ tabs, activeId, onChange, autoFocus = false, getTabId, getPanelId, testIdPrefix }: TabsProps) {
            ...
            {tabs.map((tab, index) => {
                ...
                return (
                    <TabButton
                        ...
                        testId={testIdPrefix ? `${testIdPrefix}-${tab.id}` : undefined}
                        active={isActive}
